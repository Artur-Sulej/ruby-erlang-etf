...
class Erlang::ETF::NewFloatTest < Minitest::Test
  ...
  def test_new
    ...
    assert_equal Erlang.from(-1.1), etf.term
    etf = Erlang::ETF::NewFloat[BigDecimal("1.12233445566778899001e-03")]
    assert_equal Erlang.from(BigDecimal("1.12233445566778899001e-03")), etf.term
  end
  ...
  def test_erlang_dump
    ...
    binary = Erlang::ETF::NewFloat[BigDecimal("1.12233445566778899001e-03")].erlang_dump
  ...
  def test_to_erlang
    ...
    etf = Erlang::ETF::NewFloat[BigDecimal("1.12233445566778899001e-03")]
    assert_equal Erlang.from(BigDecimal("1.12233445566778899001e-03")), etf.to_erlang
  end
